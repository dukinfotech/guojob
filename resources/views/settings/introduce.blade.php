...
@section('content')
<h2>Setting trang giới thiệu </h2>
<form action="/admin/settings/introduce" method="POST">
    @csrf
    @method('PUT')
    <div class="mb-3">
        <textarea id="my-editor" name="introducepage" class="form-control">{{ $setting->introducepage }}</textarea>
    </div>
